...
namespace VibeZOData.Controllers
{
    ...
    public class PlaylistController(IPlaylistRepository _playlistRepository, ILogger<PlaylistController> _logger, IMapper _mapper, IAzuriteService _azure ) : ControllerBase
    {
        ...
        [HttpPost("CreatePlaylist", Name ="CreatePlaylist")]
        public async Task<ActionResult> CreatePlaylist(string name, string description, IFormFile image, Guid? userId)
        {
        ...
        public async Task<ActionResult> UpdatePlaylist(Guid id, string name, string description, IFormFile? image)
        {
