        ...
        <div className="bg-[#1A1A1A] p-10 rounded-xl text-center w-[550px]">
          ...
          <div className="w-full">
            <input
              ...
              className={`w-full bg-[#2A2A2A] text-white py-3 px-4 rounded-md mb-2 outline-none focus:ring-2 ${usernameError ? 'ring-2 ring-red-500' : ''}`}
            />
            {usernameError && (
              <p className="text-red-500 text-left mb-4 text-sm">{usernameError}</p>
            )}
          </div>
          ...
          <div className="relative w-full">
            <input
              ...
              className={`w-full bg-[#2A2A2A] text-white py-3 px-4 rounded-md mb-2 outline-none focus:ring-2 ${passwordError ? 'ring-2 ring-red-500' : ''}`}
            />
            <button className="absolute right-4 top-1/2 transform -translate-y-1/2">
              <img src={showIcon} alt="Show" className="w-5 h-5" />
            </button>
            {passwordError && (
              <p className="text-red-500 text-left mb-4 text-sm">{passwordError}</p>
            )}
          </div>
